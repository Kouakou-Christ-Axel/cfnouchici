...
type _CoercedEnvSchema_95db00b0 = CoercedEnvSchema;

declare module 'varlock/env' {
  export interface TypedEnvSchema extends Readonly<_CoercedEnvSchema_95db00b0> {}
  export interface PublicTypedEnvSchema extends Readonly<Pick<_CoercedEnvSchema_95db00b0, ''>> {}
}
...
type _EnvSchemaAsStrings_95db00b0 = EnvSchemaAsStrings;
declare global {

  // add types for global import.meta.env
  interface ImportMetaEnv extends _EnvSchemaAsStrings_95db00b0 {}
  ...
  namespace NodeJS {
    interface ProcessEnv extends _EnvSchemaAsStrings_95db00b0 {}
  }
}